...
int main(int argc, char **argv)
{
    ...
    char operation = 0;
    char *fname_matrix_1 = NULL;
    char *fname_matrix_2 = NULL;
    ...
    if (!result)
    {
        int count_rows = 0;
        int count_columns = 0;
        matrix_double_t *matrix_1 = NULL;
        matrix_double_t *matrix_2 = NULL;
        ...
        if (!result)
        {
            matrix_double_t *matrix_result = NULL;
            double det = 0.0;
            switch (operation)
            {
                case 'a':
                ...
                case 'm':
                    ...
                    if (matrix_result)
                        result = matrix_double_operation_multiply(matrix_1, matrix_2, matrix_result);
                    else
                        result = error_out_of_memory;
                    break;
                case 'o':
