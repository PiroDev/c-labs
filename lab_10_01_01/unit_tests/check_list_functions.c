...
START_TEST(test_sorted_insert_common)
{
    char *data_first = "1";
    char *data_second = "2";
    node_t *expected = NULL;
...
START_TEST(test_sorted_insert_null_head)
{
    char *data_first = "1";
    node_t *expected = NULL;
    expected = push_front(expected, data_first);
    node_t *element = new_node(data_first);
...
START_TEST(test_sorted_insert_null_element)
{
    char *data_first = "1";
    node_t *expected = NULL;
    expected = push_front(expected, data_first);
    node_t *buf = new_node(data_first);
...
Suite *sorted_insert_suite(void)
{
    ...
    equal_class = suite_create("sorted_insert");
    tc_pos = tcase_create("positives");
    tcase_add_test(tc_pos, test_sorted_insert_common);
    suite_add_tcase(equal_class, tc_pos);

    tc_neg = tcase_create("negatives");
    tcase_add_test(tc_neg, test_sorted_insert_null_head);
    tcase_add_test(tc_neg, test_sorted_insert_null_element);
    suite_add_tcase(equal_class, tc_neg);
